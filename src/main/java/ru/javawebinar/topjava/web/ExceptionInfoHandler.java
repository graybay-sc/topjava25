...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo notValidDataError(HttpServletRequest req, BindException e) {
        return logAndGetErrorInfo(req, e, false, VALIDATION_ERROR);
    }
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType) {
        Throwable rootCause = logAndGetCause(req, e, logException, errorType);
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, BindException e, boolean logException, ErrorType errorType) {
        return logAndGetErrorInfo(req, e, logException, errorType, ValidationUtil.getErrorMessage(e.getBindingResult()));
    }
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String errorMessage) {
        logAndGetCause(req, e, logException, errorType);
        return new ErrorInfo(req.getRequestURL(), errorType, errorMessage);
    }

    private static Throwable logAndGetCause(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType) {
