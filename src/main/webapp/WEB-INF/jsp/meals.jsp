...
<section>
    ...
    <form method="get" action="${pageContext.request.contextPath}/meals/filter">
        ...
        <button type="submit"><spring:message code="meal.button_filter"/></button>
    </form>
    <hr/>
    ...
    <table border="1" cellpadding="8" cellspacing="0">
        <thead>
        <tr>
            <th><spring:message code="meal.column_date"/></th>
            <th><spring:message code="meal.column_description"/></th>
            <th><spring:message code="meal.column_calories"/></th>
            <th></th>
            <th></th>
        </tr>
        </thead>
        <c:forEach items="${requestScope.meals}" var="meal">
            ...
            <tr data-meal-excess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="${pageContext.request.contextPath}/meals/${meal.id}"><spring:message code="meal.button_update"/></a></td>
                <td><a href="${pageContext.request.contextPath}/meals/delete/${meal.id}"><spring:message code="meal.button_delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
